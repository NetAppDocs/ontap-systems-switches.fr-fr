...
summary: 'SSH est requis lors de l"utilisation des fonctions de contrôle de l"état des commutateurs de cluster et de collecte des journaux. Pour activer SSH sur les commutateurs de cluster Cisco 92300YC, vous générez d"abord les clés SSH, puis vous activez SSH.' 
---
