...
summary: Vous pouvez installer le commutateur Cisco Nexus 92300YC et le panneau de passage dans une armoire NetApp avec les supports standard fournis avec le commutateur. 
---
= Installer un commutateur de cluster Cisco Nexus 92300YC dans une armoire NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Selon votre configuration, vous devrez peut-être installer le commutateur de cluster Cisco Nexus 92300YC et le panneau de transfert dans une armoire NetApp avec les supports standard fournis avec le commutateur.

.Avant de commencer
* Les exigences de préparation initiale, le contenu du kit et les précautions de sécurité dans lelink:https://www.cisco.com/site/us/en/products/networking/cloud-networking-switches/nexus-9200-series-switches/index.html["Guide d'installation matérielle de la gamme Cisco Nexus 9000"^] .
* Pour chaque interrupteur, les huit vis 10-32 ou 12-24 et les écrous clips pour monter les supports et les rails coulissants sur les montants avant et arrière de l'armoire.
...
. Installez les supports de montage en rack sur le châssis du commutateur Nexus 92300YC.
+
...
+
Les deux commutateurs 92300YC seront toujours montés dans les 2U supérieurs de l'armoire RU41 et 42.
...
+
image::../media/3132q_v_positioning.gif[Positionnement 92300YC à U39-40]
...
====
. Connectez le port de gestion de chaque commutateur 92300YC à l'un des commutateurs de gestion (si commandés) ou connectez-les directement à votre réseau de gestion.
+
...
Une fois les commutateurs installés dans l'armoire NetApp , vous pouvezlink:configure-install-initial.html["configurer le commutateur"] .
