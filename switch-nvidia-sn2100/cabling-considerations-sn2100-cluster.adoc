...
====
.Et la suite ?
Après avoir examiné vos exigences en matière de câblage et de configuration, vous link:install-cable-shelves-sn2100-cluster.html["câbler les étagères NS224 comme un rangement relié à un interrupteur"].
