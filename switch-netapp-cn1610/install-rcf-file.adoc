...
+
Assurez-vous de consulter le tableau de compatibilité des commutateurs sur le http://["Commutateurs NetApp CN1601 et CN1610"^] Pour les versions RCF et ONTAP prises en charge.
