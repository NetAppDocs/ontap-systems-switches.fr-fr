...
[role="lead"]
Vous pouvez utiliser cette procédure pour installer le logiciel NX-OS sur le commutateur de cluster Nexus 3132Q-V.
...
+
Cet exemple montre que le système SFTP est utilisé pour copier le logiciel NX-OS sur le commutateur Nexus 3132Q-V :
