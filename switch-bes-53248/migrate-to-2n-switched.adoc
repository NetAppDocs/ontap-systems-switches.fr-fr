...
+
Le link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] contient les informations les plus récentes concernant les ports de cluster actuels pour vos plateformes.
...
+
Le link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] contient plus d'informations sur le câblage.
