...
---
= Terminez votre migration des switchs CN1610 vers des switchs 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Procédez comme suit pour finaliser la migration des switchs CN1610 vers des switchs Nexus 3232C.
