...
* *Afficher et migrer les ports du cluster vers le commutateur C2 (étapes ,1-,7)*
* *Rebrancher les câbles ISL du commutateur CL2 au commutateur C2, puis migrer les liens ISL vers le commutateur CL1 et C2 (étapes ,8-,14)*
* *Revert toutes les LIFs vers les ports attribués à l'origine (étapes ,15-,18)*
* *Vérifiez que tous les ports et LIF sont correctement migrés (étapes ,19-,21)*
