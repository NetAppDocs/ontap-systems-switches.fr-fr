...
----
====
. Migrer les LIF associées au premier commutateur CN1610 CL1 :
+
...
----
====
. [[quarante]]activez la fonction de collecte des journaux du moniteur d'intégrité du commutateur de cluster pour collecter les fichiers journaux relatifs au commutateur :
+
