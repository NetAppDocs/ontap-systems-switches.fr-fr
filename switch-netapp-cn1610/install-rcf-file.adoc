...
summary: 'Lors de l"installation d"un fichier de configuration RCF, vous devez d"abord migrer les LIF du cluster hors du commutateur cs2. Une fois le RCF installé et validé, les LIF peuvent être migrées de nouveau.' 
---
...
+
Le link:https://hwu.netapp.com/["Hardware Universe"^] contient plus d'informations sur les ports de cluster réellement pris en charge sur votre plateforme.
