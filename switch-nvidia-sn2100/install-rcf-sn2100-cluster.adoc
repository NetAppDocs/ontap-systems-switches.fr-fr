...
NOTE: À l'étape 3 *mise à jour du fichier MOTD* ci-dessus, la commande `cat /etc/issue` est exécuté. Cela vous permet de vérifier le nom de fichier RCF, la version RCF, les ports à utiliser et d'autres informations importantes dans la bannière RCF.
