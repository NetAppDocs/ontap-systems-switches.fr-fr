...
summary: Vous pouvez utiliser cette procédure pour installer le logiciel NX-OS sur le commutateur de cluster Nexus 3232C. 
---
...
[role="lead"]
Vous pouvez utiliser cette procédure pour installer le logiciel NX-OS sur le commutateur de cluster Nexus 3232C.
...
+
Reportez-vous à link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["Notes de version de la mise à niveau EPLD, version 9.3(11)"^] pour plus de détails.
...
Après avoir installé le logiciel NX-OS, vous pouvez link:install-upgrade-rcf-overview-3232c.html["installer ou mettre à niveau le fichier de configuration de référence (RCF)"].
