...
summary: Vous pouvez installer le commutateur Cisco Nexus 3232C et le panneau de passage dans une armoire NetApp avec les supports standard fournis avec le commutateur. 
---
= Installer un commutateur de cluster Cisco Nexus 3232C dans une armoire NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Selon votre configuration, vous devrez peut-être installer le commutateur de cluster Cisco Nexus 3232C et le panneau de transfert dans une armoire NetApp avec les supports standard fournis avec le commutateur.

.Avant de commencer
* Les exigences de préparation initiale, le contenu du kit et les précautions de sécurité dans lelink:http://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus3000/hw/installation/guide/b_n3000_hardware_install_guide.html["Guide d'installation matérielle de la gamme Cisco Nexus 3000"^] .
...
. Installez les supports de montage en rack sur le châssis du commutateur Nexus 3232C.
+
