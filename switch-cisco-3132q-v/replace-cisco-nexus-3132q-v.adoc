...
summary: 'Le remplacement d"un commutateur Cisco Nexus 3132Q-V défectueux dans un réseau en cluster est une procédure non perturbatrice (NDU) et vous devez effectuer une séquence de tâches spécifique.' 
---
...
* Déclenchez une maintenance AutoSupport avant et après la maintenance afin de désactiver la création de tickets pendant toute la durée de la maintenance. Consultez cet article de la Knowledge Base link:https://kb.netapp.com/Support_Bulletins/Customer_Bulletins/SU92["SU92 : Comment désactiver la création automatique de tickets pendant les fenêtres de maintenance planifiées ?"^] pour plus de détails.
...
* Les nœuds sont n1, n2, n3 et n4. - Les exemples de cette procédure utilisent quatre nœuds : deux nœuds utilisent quatre ports d’interconnexion de cluster de 10 Go : e0a, e0b, e0c et e0d. Les deux autres nœuds utilisent deux ports d’interconnexion de cluster de 40 Go : e4a et e4e. Consultez le link:https://hwu.netapp.com/["Hardware Universe"^] pour connaître les ports de cluster réels sur vos plateformes.
...
+
.. Sur le site de support NetApp, consultez link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch/["Commutateurs Ethernet Cisco"^].
