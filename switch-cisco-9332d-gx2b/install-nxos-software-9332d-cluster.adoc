...
* Terminez la procédure danslink:install-nxos-overview-9332d-cluster.html["Préparez-vous à installer NX-OS et RCF"] .
...
Après avoir installé ou mis à jour le logiciel NX-OS, vous pouvez link:install-upgrade-rcf-overview-cluster-9332d.html["installer ou mettre à niveau le fichier de configuration de référence (RCF)"].
