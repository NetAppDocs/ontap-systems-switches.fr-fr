...
[role="lead"]
Vous pouvez installer la FCR après la première configuration du commutateur Nexus 3132Q-V. Vous pouvez également utiliser cette procédure pour mettre à niveau votre version RCF.
...
+
Cet exemple montre le fichier RCF `Nexus_3132QV_RCF_v1.6-Cluster-HA-Breakout.txt` en cours d'installation sur le commutateur cs2 :
...
cluster1::*>
----
. Répétez les étapes 7 à 16 sur le commutateur cs1.
