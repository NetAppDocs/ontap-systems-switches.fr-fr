...
summary: 'L"utilisation du protocole SSH est requise pour le Cluster Switch Health Monitor (CSHM) et la collecte des journaux. Pour activer SSH sur les commutateurs de cluster BES-53248, vous devez d"abord générer les clés SSH, puis activer SSH.' 
---
