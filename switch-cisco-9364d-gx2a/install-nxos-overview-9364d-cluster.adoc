...
summary: Préparez-vous à installer le logiciel NX-OS et RCF. 
---
...
Une fois que vous avez préparé l'installation du logiciel NX-OS et de RCF, vous link:install-nxos-software-9364d-cluster.html["installer ou mettre à niveau le logiciel NX-OS"].
