...
====
.Et la suite ?
Après avoir installé Cumulus Linux en mode ONIE, vous link:install-rcf-sn2100-cluster.html["installer le script du fichier de configuration de référence (RCF)"].
