...
summary: 'SSH est requis lors de l"utilisation des fonctionnalités Cluster Switch Health Monitor et de collecte des journaux. Pour activer SSH sur les commutateurs de cluster Cisco 9332d-gx2b, vous générez d"abord les clés SSH, puis vous activez SSH.' 
---
