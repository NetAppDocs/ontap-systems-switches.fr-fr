...
Après avoir examiné les exigences de migration, vous pouvezlink:migrate-from-switchless-prepare-to-migrate.html["Préparez-vous à migrer vos commutateurs"] .
