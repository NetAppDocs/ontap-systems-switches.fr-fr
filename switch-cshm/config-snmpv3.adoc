...
NOTE: SNMPv3 n'est pris en charge que sur ONTAP 9.12.1 et versions ultérieures.
...
--
Configurez un nom d'utilisateur SNMPv3 SNMPv3_USER sur les switches Broadcom BES-53248.
...
.NVIDIA : CLI 5.4
--
Configurer un nom d'utilisateur SNMPv3 SNMPv3_USER sur les commutateurs NVIDIA SN2100 exécutant CLI 5.4 :
