...
* Le commutateur CL2 du bloc d'instruments doit être remplacé par C2 (,Étapes 2 - ,22)
+
...
* Le commutateur CL1 du bloc d'instruments doit être remplacé par C1 (,Étapes 23 - ,43)
+
