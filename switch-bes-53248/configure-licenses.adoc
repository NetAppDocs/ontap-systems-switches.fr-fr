...
NOTE: Pour échanger une clé de transaction contre un fichier de clé de licence de port, consultez link:https://support.broadcom.com/web/csg/license-generation["Portail de licences pour les commutateurs Ethernet compatibles Broadcom"^]. Consultez l'article de la base de connaissances link:https://kb.netapp.com/on-prem/Switches/Broadcom-KBs/How_to_add_Additional_Port_Licensing_for_the_Broadcom_BES_53248_Switch["Comment ajouter des licences de port supplémentaires pour le commutateur Broadcom BES-53248"^] pour plus de détails.
