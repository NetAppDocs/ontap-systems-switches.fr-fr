...
[role="lead"]
Vous pouvez migrer d'anciens commutateurs Cisco pour un cluster ONTAP vers des commutateurs de stockage NVIDIA SN2100. Il s’agit d’une procédure non perturbatrice.



== Exigences de révision

Vous devez être conscient de certaines informations de configuration, des connexions de ports et des exigences de câblage lorsque vous remplacez d'anciens commutateurs Cisco par des commutateurs de stockage NVIDIA SN2100. Reportez-vous à link:configure-overview-sn2100-cluster.html["Présentation de l'installation et de la configuration des commutateurs NVIDIA SN2100"].
...
Pour plus de détails sur les ports pris en charge et leurs configurations, reportez-vous au link:https://hwu.netapp.com/["Hardware Universe"^].
...
** Tous les LIF du cluster à l'état *actif* sont connectés à leurs ports d'origine.
** Les ports ISL sont activés et câblés entre les anciens commutateurs Cisco et entre les nouveaux commutateurs.


* Certains ports des commutateurs NVIDIA SN2100 sont configurés pour fonctionner à 100 GbE.
...
----
====
. Les ports de stockage de chaque nœud sont connectés aux commutateurs de stockage existants de la manière suivante (du point de vue des nœuds) à l'aide de la commande :
+
...
----
====
. Sur les commutateurs S1 et S2, les ports de stockage et les commutateurs sont connectés de la manière suivante (du point de vue des commutateurs) à l'aide de la commande :
+
`show lldp neighbors`
...
----
====
. Du point de vue des nœuds, les ports de stockage de chaque nœud sont désormais connectés aux commutateurs de la manière suivante :
+
.Afficher un exemple
[%collapsible]
====
...
. Créez un mot de passe pour la fonction de collecte des journaux de surveillance de l'état du commutateur Ethernet :
+
...
----
====
. Activez la fonction de collecte des journaux de surveillance de l'état du commutateur Ethernet :
+
