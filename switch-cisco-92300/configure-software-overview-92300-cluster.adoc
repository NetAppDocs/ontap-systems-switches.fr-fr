...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["Deux"]link:install-nxos-overview.html["Préparez-vous à installer le logiciel NX-OS et RCF."]
[role="quick-margin-para"]
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Quatre"]link:install-the-rcf-file.html["Installez le RCF"]
[role="quick-margin-para"]
