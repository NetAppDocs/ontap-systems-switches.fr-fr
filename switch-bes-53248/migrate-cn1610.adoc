...
Le https://["_NetApp Hardware Universe_"^] Contient des informations sur la compatibilité ONTAP, le micrologiciel EFOS pris en charge et le câblage aux commutateurs de cluster BES-53248.
...
+
Vous devez ensuite reconnecter les ports déconnectés de tous les nœuds au nouveau commutateur BES-53248 cs2. Reportez-vous à la https://["_NetApp Hardware Universe_"^] pour les options de câblage approuvées.
...
+
Vous devez ensuite reconnecter les ports déconnectés de tous les nœuds au nouveau commutateur BES-53248 cs1. Reportez-vous à la https://["_NetApp Hardware Universe_"^] pour les options de câblage approuvées.
