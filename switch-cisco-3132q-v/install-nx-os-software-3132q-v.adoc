...
. Copiez le logiciel NX-OS sur le commutateur Nexus 3132Q-V en utilisant l'un des protocoles de transfert suivants : FTP, TFTP, SFTP ou SCP.  Pour plus d'informations sur les commandes Cisco , consultez le guide approprié. https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Guides de référence des commandes NX-OS Cisco Nexus série 3000"^] .
+
.Afficher un exemple
[%collapsible]
====
...
----
====
. Répétez les étapes 6 à 11 sur le commutateur cs1.
...
Après avoir installé le logiciel NX-OS, vous pouvez link:install-upgrade-rcf-overview-3132q-v.html["installer ou mettre à niveau le fichier de configuration de référence (RCF)"].
