...
NOTE: Le système d'exploitation Cumulus Linux (CL) peut être installé soit lorsque le commutateur exécute Cumulus Linux, soit lorsqu'il exécute ONIE (voirlink:install-onie-mode-sn2100-storage.html["Installer en mode ONIE"] ).
