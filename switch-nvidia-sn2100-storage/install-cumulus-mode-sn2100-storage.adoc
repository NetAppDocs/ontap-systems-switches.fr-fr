...
NOTE: Le système d'exploitation Cumulus Linux (CL) peut être installé soit lorsque le commutateur exécute Cumulus Linux, soit ONIE (voir link:install-onie-mode-sn2100-storage.html["Installer en mode ONIE"]).
...
----
+
Consultez l'article de la base de connaissances link:https://kb.netapp.com/on-prem/Switches/Nvidia-KBs/NTP_Server_configuration_is_not_working_with_NVIDIA_SN2100_Switches["La configuration du serveur NTP ne fonctionne pas avec les commutateurs NVIDIA SN2100."^] pour plus de détails.
...
----
+
Reportez-vous à link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-54/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["Comptes utilisateurs NVIDIA"^] pour plus d’informations.
...
Reportez-vous à link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["Comptes utilisateurs NVIDIA"^] pour plus d’informations.

--
====
.Quelle est la prochaine étape ?
Après avoir installé Cumulus Linux en mode Cumulus, vous pouvezlink:install-rcf-sn2100-storage.html["installer ou mettre à niveau le script RCF"] .
