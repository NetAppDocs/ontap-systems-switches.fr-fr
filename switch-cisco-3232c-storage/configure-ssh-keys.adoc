...
summary: 'SSH est requis lors de l"utilisation des fonctionnalités de contrôle de l"état des commutateurs de cluster et de collecte des journaux. Pour activer SSH sur les commutateurs de cluster Cisco 3232C, vous générez d"abord les clés SSH, puis vous activez SSH.' 
---
