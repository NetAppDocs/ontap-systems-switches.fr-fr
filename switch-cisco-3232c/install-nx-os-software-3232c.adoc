...
Après avoir installé le logiciel NX-OS, vous link:install-upgrade-rcf-overview-3232c.html["installer ou mettre à niveau le fichier de configuration de référence (RCF)"].
