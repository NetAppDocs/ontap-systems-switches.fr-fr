...
summary: Le logiciel Cisco NX-OS et les fichiers de configuration de référence doivent être installés sur les commutateurs de cluster Cisco Nexus 9332D-GX2B. 
---
