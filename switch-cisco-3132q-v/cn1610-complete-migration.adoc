...
---
= Terminez votre migration des commutateurs CN1610 vers les commutateurs Nexus 3132Q-V.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Procédez comme suit pour finaliser la migration des commutateurs CN1610 vers les commutateurs Nexus 3132Q-V.
