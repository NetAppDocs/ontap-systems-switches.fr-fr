...
.Avant de commencer
* Téléchargez le logiciel Broadcom EFOS correspondant à vos commutateurs de cluster à partir du https://["Prise en charge des commutateurs Ethernet Broadcom"^] le site.
