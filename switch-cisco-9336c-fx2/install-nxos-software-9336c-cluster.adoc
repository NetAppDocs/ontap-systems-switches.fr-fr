...
[role="lead"]
Suivez cette procédure pour installer ou mettre à niveau le logiciel NX-OS sur le commutateur de cluster Nexus 9336C-FX2.
...
.Et la suite ?
link:install-upgrade-rcf-overview-cluster.html["Installation ou mise à niveau du fichier RCF (Reference Configuration File)"]
