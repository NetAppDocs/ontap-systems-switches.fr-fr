...
En réutilisant les commutateurs de stockage, les switchs de stockage de la paire haute disponibilité 1 deviennent les switchs partagés.
*Schéma de câblage pour connexion à un commutateur*
