...
NOTE: Pour plus d'informations sur l'installation de Cumulus Linux, consultez link:configure-software-overview-sn2100-cluster.html["Processus d'installation logicielle pour les commutateurs NVIDIA SN2100"].
...
Consultez la documentation link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/Installation-Management/Factory-Reset/["Réinitialisation d'usine"^] NVIDIA pour plus de détails.
