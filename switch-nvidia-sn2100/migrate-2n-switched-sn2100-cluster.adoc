...
IMPORTANT: Veuillez consulter link:cabling-considerations-sn2100-cluster.html["Examiner les considérations relatives au câblage et à la configuration"] pour connaître les mises en garde et obtenir plus de détails. Le link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe - Commutateurs"^] contient également des informations supplémentaires sur le câblage.
...
--
====
. [[étape 8]]Rétablissez le niveau de privilège à administrateur :
+
`set -privilege admin`
