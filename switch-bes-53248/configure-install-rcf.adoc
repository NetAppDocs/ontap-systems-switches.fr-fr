...
----
====
. Sur le commutateur de cluster cs2, faites apparaître les ports connectés aux ports de cluster des nœuds.
+
[listing, subs="+quotes"]
----
(cs2)(Config)# *interface 0/1-0/16*
...
--
====
. [[step18]]sur le commutateur de cluster cs1, arrêtez les ports connectés aux ports de cluster des nœuds.
+
