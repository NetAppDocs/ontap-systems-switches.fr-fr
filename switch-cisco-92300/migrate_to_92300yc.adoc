...
---
= Comment migrer d'un commutateur Cisco vers un commutateur Cisco Nexus 92300YC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Les commutateurs de cluster Nexus 92300YC doivent être configurés et opérationnels sous la version adéquate du fichier NX-OS installé et du fichier RCF (Reference Configuration File) appliqué.
