...
summary: 'L"utilisation du protocole SSH est requise pour le contrôle de l"état des commutateurs de cluster CSHM et la collecte des journaux. Pour activer SSH sur les commutateurs de cluster BES-53248, vous devez d"abord générer les clés SSH, puis activer SSH.' 
---
