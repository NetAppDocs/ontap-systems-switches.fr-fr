...
----
====
. Si vous effectuez une mise à niveau vers NX-OS version 9.3(11), vous devez mettre à niveau l'image EPLD `golden` et redémarrer le commutateur. Sinon, passez à l'étape 12.
+
Voir https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["Notes de mise à niveau EPLD, version 9.3(11)"^] pour plus de détails.
