...
---
= Effectuez la migration de clusters à 2 nœuds sans commutateur vers des clusters à 2 nœuds avec commutateur
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Procédez comme suit pour effectuer la migration de clusters sans commutateur vers des clusters à 2 nœuds avec commutateur.
