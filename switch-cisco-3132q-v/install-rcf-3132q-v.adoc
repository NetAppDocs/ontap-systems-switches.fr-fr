...
. Copiez le RCF sur le bootflash du commutateur cs2 à l'aide de l'un des protocoles de transfert suivants : FTP, TFTP, SFTP ou SCP. Pour plus d'informations sur les commandes Cisco, reportez-vous au guide approprié dans le https://["Référence des commandes Cisco Nexus série 3000 NX-OS"^] guides.
+
.Montrer l'exemple
[%collapsible]
====
...
+
Pour plus d'informations sur les commandes Cisco, reportez-vous au guide approprié dans le https://["Référence des commandes Cisco Nexus série 3000 NX-OS"^] guides.
