...
---
= Préparez-vous à la migration des commutateurs Nexus 5596 vers les commutateurs Nexus 3232C.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Suivez ces étapes pour préparer vos commutateurs Cisco Nexus 5596 à la migration vers les commutateurs Cisco Nexus 3232C.
...
+
Consultez la page de téléchargement des fichiers de configuration de référence du commutateur de réseau de cluster et de gestion __ONTAP 8.x ou version ultérieure__, puis sélectionnez la version appropriée.
...
Une fois que vous avez préparé la migration de vos commutateurs, vous pouvezlink:cn5596-configure-ports.html["configurez vos ports"] .
