...
NOTE: Reportez-vous à link:cabling-considerations-sn2100-storage.html["Considérations relatives au câblage et à la configuration"] pour les mises en garde et plus de détails.
...
+
Le link:https://hwu.netapp.com["Hardware Universe"^] contient les informations les plus récentes concernant les ports de cluster actuels pour vos plateformes.
