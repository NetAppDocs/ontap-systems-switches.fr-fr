...
+
Reportez-vous aux guides de mise à niveau et de logiciels appropriés disponibles sur le site Web de Cisco pour obtenir la documentation complète sur les procédures de mise à niveau et de mise à niveau vers une version antérieure du commutateur Cisco.
...
Les exemples de cette procédure utilisent quatre nœuds. Ces nœuds utilisent deux ports d'interconnexion de clusters 10GbE e0a et e0b. Voir la https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe"] pour vérifier les ports de cluster appropriés sur vos plates-formes.
...
== Option 1 : installez le fichier RCF sur un nouveau commutateur
...
== Option 2 : mise à niveau des switchs existants avec une nouvelle version RCF
...
. Réappliquez tous les ajouts personnalisés précédemment identifiés à la configuration du commutateur.
