...
* Commutateur de remplacement Nexus 92300YC :
+
...
** Tous les ports ISL (Inter-Switch Link) doivent être désactivés sur les ports 1/65 et 1/66.
...
+
link:https://docs.netapp.com/us-en/ontap-systems-switches/switch-cisco-92300/configure-overview.html["Configurez un nouveau commutateur Cisco Nexus 92300YC"^]
