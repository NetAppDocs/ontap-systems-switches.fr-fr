...
* link:https://kb.netapp.com/Support_Bulletins/Customer_Bulletins/SU540["SU540 : Des erreurs de carte réseau Chelsio T6 entraînent l’arrêt du système lors de la mise à niveau des commutateurs réseau de 40 Gbit/s vers 100 Gbit/s"^]
