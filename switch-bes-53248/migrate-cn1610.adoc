...
* Certains ports des commutateurs BES-53248 sont configurés pour s'exécuter à 10 GbE ou 40 GbE.
* La connectivité 10 GbE et 40 GbE entre les nœuds et les commutateurs de cluster BES-53248 a été planifiée, migrée et documentée.
...
----
. Sur le commutateur de cluster CL1, arrêter les ports connectés aux ports de cluster des nœuds :
+
.Montrer l'exemple
[%collapsible]
====
...
----
====
. Déplacez tous les câbles de connexion des nœuds du cluster de l'ancien commutateur CS2 vers le nouveau commutateur cs2.
...
----
====
. Vérifiez les connexions des ports de commutateur du point de vue du commutateur cs2 à l'aide des commandes :
+
[listing, subs="+quotes"]
----
...
----
. Sur le commutateur de cluster CL2, arrêtez les ports connectés aux ports de cluster des nœuds.
+
[listing, subs="+quotes"]
----
(CL2)# *configure*
...
----
====
. Vérifiez les connexions des ports de commutateur du point de vue du commutateur cs1 à l'aide des commandes :
+
[listing, subs="+quotes"]
----
...
--
Pour ONTAP 9.4 et les versions antérieures, utilisez la commande : `system cluster-switch delete -device _device-name_`
...
IMPORTANT: Pour activer la fonction de collecte de journaux, vous devez exécuter ONTAP 9.12.1 et versions ultérieures, ainsi que EFOS 3.8.0.2 et versions ultérieures.
