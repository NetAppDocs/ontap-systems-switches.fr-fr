...
Les versions d'ONTAP et de NX-OS prises en charge dans cette procédure sont indiquées sur la page Cisco Ethernet Switches. Reportez-vous à  https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Commutateurs Ethernet Cisco"^].
...
Le link:https://hwu.netapp.com["Hardware Universe"^] contient des informations sur le câblage pris en charge pour tous les commutateurs du cluster.
