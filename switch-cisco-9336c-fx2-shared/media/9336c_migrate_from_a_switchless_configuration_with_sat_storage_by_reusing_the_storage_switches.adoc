...
----
. [[step7]]remplacer la FCR de stockage sur le commutateur a partagé par le fichier RCF partagé. Voir http://["Installez le FCR sur un commutateur partagé Cisco Nexus 9336C-FX2"] pour plus d'informations.
