...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Quatre"]link:install-upgrade-rcf-overview-9336c-storage.html["Installez ou mettez à niveau le RCF"]
[role="quick-margin-para"]
