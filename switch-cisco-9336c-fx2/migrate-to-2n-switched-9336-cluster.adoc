...
[role="lead"]
Si vous disposez d'un environnement de cluster _sans commutateur_ à deux nœuds existant, vous pouvez migrer vers un environnement de cluster _commuté_ à deux nœuds à l'aide des commutateurs Cisco Nexus 9336C-FX2 et 9336C-FX2-T.
...
Consultez la link:https://hwu.netapp.com["Hardware Universe"^] pour obtenir des informations sur les ports de cluster de vos plateformes. Consultez link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["De quelles informations supplémentaires ai-je besoin pour installer mon équipement qui ne figure pas dans HWU ?"^] pour obtenir des informations supplémentaires sur les exigences d'installation du commutateur.
...
----
====
. Désactiver la restauration automatique sur toutes les LIF du cluster :
+
...
[%collapsible]
====
L'exemple suivant montre que tous les LIFs sont opérationnels sur node1 et node2 :
