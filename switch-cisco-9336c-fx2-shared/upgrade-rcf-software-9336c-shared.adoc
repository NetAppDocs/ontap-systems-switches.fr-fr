...
.. Pour NX-OS 10.2 et versions ultérieures, utilisez la `show diff running-config` commande pour comparer avec le fichier RCF enregistré dans le bootflash. Sinon, utilisez un outil de comparaison ou de diff tiers.
