...
* Pour connaître les exigences de préparation initiale, le contenu de la trousse et les précautions de sécurité, consultez https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/aci_9336cfx2_hig/guide/b_n9336cFX2_aci_hardware_installation_guide.html["Guide d'installation matérielle de la gamme Cisco Nexus 9000"^] .
