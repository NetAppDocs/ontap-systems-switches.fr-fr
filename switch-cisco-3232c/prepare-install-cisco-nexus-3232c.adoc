...
summary: 'Le logiciel Cisco NX-OS et les fichiers de configuration de référence (RCF) doivent être installés sur les commutateurs de cluster Cisco Nexus 3232C.' 
---
...
Une fois que vous avez préparé l'installation du logiciel NX-OS et de RCF, vous pouvez link:install-nx-os-software-3232c.html["installer le logiciel NX-OS"].
