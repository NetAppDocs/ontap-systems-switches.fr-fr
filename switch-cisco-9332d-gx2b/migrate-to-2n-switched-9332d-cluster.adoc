...
** Consultez la  https://hwu.netapp.com["Hardware Universe"^] pour toutes les versions ONTAP prises en charge.
...
+
Consultez le  https://hwu.netapp.com["Hardware Universe"^] pour plus d'informations sur le câblage.
