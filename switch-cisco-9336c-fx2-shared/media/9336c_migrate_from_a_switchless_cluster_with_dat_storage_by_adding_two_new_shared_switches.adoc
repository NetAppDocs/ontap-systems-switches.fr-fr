...
La plupart des systèmes requièrent deux ports dédiés du réseau cluster sur chaque contrôleur. Voir  https://["Commutateurs Ethernet Cisco"] pour en savoir plus.
...
** La solution NetApp https://["Hardware Universe"] contient plus d'informations sur le câblage.
...
* Les ports de cluster utilisés dans cette procédure sont _e3a_ et _e3b_, comme pour le contrôleur AFF A400. Le https://["Hardware Universe"] contient les informations les plus récentes sur les ports de cluster réels de vos plates-formes.
