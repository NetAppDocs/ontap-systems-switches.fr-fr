...
summary: 'Vous pouvez utiliser cette procédure pour configurer SNMPv3 pour votre commutateur spécifique, qui prend en charge le contrôle de l"état des commutateurs Ethernet CSHM.' 
---
