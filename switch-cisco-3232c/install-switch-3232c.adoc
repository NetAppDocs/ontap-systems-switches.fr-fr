...
* Complétélink:setup-worksheet-3232c.html["fiches de câblage"] .
...
.Et la suite ?
En option, vous pouvezlink:install-cisco-nexus-3232c.html["installer un commutateur Cisco Nexus 3223C dans une armoire NetApp"] .  Sinon, allez àlink:cabling-considerations-3232c.html["Examiner le câblage et la configuration"] .
