...
--
====
. [[step20]]sur le commutateur de cluster cs1, arrêtez les ports connectés aux ports de cluster des nœuds.
+
...
.Et la suite ?
link:configure-ssh.html["Activez SSH pour la collecte des journaux"].
