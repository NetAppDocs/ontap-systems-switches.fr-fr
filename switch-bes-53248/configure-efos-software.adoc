...
----
====
. Terminez l'installation.  Suivez ces cinq étapes pour reconfigurer le commutateur :
+
...
----
====
. Terminez l'installation.  Le commutateur redémarre sans aucune configuration appliquée et se réinitialise aux paramètres d'usine.  Suivez ces six étapes pour reconfigurer le commutateur :
+
