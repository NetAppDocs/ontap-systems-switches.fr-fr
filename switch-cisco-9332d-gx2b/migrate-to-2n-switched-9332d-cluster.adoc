...
----
====
. Déconnectez le câble du port de cluster e0a sur le nœud 1, puis connectez e0a au port 1 du commutateur de cluster cs1, à l'aide du câblage approprié pris en charge par les commutateurs 9332D-GX2B.
+
...
. Déconnectez le câble du port de cluster e0a sur le nœud 2, puis connectez e0a au port 2 sur le commutateur de cluster cs1, à l'aide du câblage approprié pris en charge par les commutateurs 9332D-GX2B.
