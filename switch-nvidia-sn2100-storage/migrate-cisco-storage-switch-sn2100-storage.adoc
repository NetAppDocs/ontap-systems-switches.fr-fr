...
* Cisco Nexus 3232C
* Reportez-vous à la link:https://hwu.netapp.com/["Hardware Universe"^] pour obtenir tous les détails concernant les ports pris en charge et leurs configurations.
