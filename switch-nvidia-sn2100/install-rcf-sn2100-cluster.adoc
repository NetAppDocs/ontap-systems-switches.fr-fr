...
NOTE: Pendant `scp` est utilisé dans l'exemple, vous pouvez utiliser votre méthode préférée de transfert de fichiers.
...
NOTE: Bien que `scp` est utilisé dans l'exemple, vous pouvez utiliser votre méthode préférée de transfert de fichiers.
