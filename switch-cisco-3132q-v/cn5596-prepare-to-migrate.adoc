...
---
= Préparez-vous à la migration des commutateurs Nexus 5596 vers les commutateurs Nexus 3132Q-V.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Suivez ces étapes pour préparer vos commutateurs Cisco Nexus 5596 à la migration vers les commutateurs Cisco Nexus 3132Q-V.
...
----
====
. Vérifiez que le RCF et l'image appropriés sont installés sur les nouveaux commutateurs 3132Q-V selon vos besoins, et effectuez les personnalisations essentielles du site, telles que les utilisateurs et les mots de passe, les adresses réseau, etc.
+
...
+
Consultez la page de téléchargement des fichiers de configuration de référence du commutateur réseau de cluster et de gestion __ONTAP 8.x ou version ultérieure__, puis sélectionnez la version appropriée.
...
--
====
. [[étape 10]] Fermez les ports ISL 41 à 48 sur le commutateur Nexus 5596 actif CL1 :
+
.Afficher un exemple
[%collapsible]
====
L'exemple suivant montre comment désactiver les ports ISL 41 à 48 sur le commutateur Nexus 5596 CL1 :
...
. Établir une liaison ISL temporaire entre CL1 et C2.
+
.Afficher un exemple
[%collapsible]
====
