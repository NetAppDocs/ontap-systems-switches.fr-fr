...
.Et la suite ?
En option, vous pouvezlink:install-switch-and-passthrough-panel-9336c-cluster.html["Installez un commutateur Cisco Nexus 9336C-FX2 dans une armoire NetApp"] . Sinon, allez àlink:cabling-considerations-9336c-fx2.html["revoir le câblage et la configuration"] .
