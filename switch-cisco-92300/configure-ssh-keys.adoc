...
summary: 'L"utilisation du protocole SSH est requise pour le moniteur d"intégrité des commutateurs de cluster (CSHM) et la collecte des journaux. Pour activer SSH sur les commutateurs de cluster Cisco 92300YC, vous devez d"abord générer les clés SSH, puis activer SSH.' 
---
