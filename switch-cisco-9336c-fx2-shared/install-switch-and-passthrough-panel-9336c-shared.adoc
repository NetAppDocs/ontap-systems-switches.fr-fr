...
[role="lead"]
Selon votre configuration, vous pourriez avoir besoin d'installer le commutateur Cisco Nexus 9336C-FX2 et le panneau de transfert dans une armoire NetApp . Des supports standard sont inclus avec le commutateur.
