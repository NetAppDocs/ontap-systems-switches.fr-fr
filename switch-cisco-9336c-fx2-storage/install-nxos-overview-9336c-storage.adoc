...
.Et la suite ?
Après avoir préparé l'installation du logiciel NX-OS et RCF, vouslink:install-nxos-software-9336c-storage.html["installer ou mettre à niveau le logiciel NX-OS"] .
