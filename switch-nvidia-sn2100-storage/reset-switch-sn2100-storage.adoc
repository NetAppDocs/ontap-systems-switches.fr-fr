...
NOTE: Pour plus d'informations sur l'installation de Cumulus Linux, consultez link:configure-software-sn2100-storage.html["Processus d'installation logicielle pour les commutateurs NVIDIA SN2100"].
...
Consultez la documentation NVIDIA https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/Installation-Management/Factory-Reset/["Réinitialisation d'usine"^] pour plus de détails.
