...
* Cumulus Linux est installé. Voir la https://["Hardware Universe"^] pour les versions prises en charge.
...
Deux scripts RCF sont disponibles pour les applications de cluster et de stockage. Téléchargez les fichiers RCF depuis https://["ici"^]. La procédure pour chaque est la même.
...
NOTE: Pour tout problème de script FCR python qui ne peut pas être corrigé, contactez https://["Support NetApp"^] pour obtenir de l'aide.
