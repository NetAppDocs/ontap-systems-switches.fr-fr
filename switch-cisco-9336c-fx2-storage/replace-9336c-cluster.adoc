...
--
====
. [[step6]] arrêter les ports ISL 1/35 et 1/36 sur le commutateur Nexus 9336C-FX2 cs1 :
+
[listing]
----
cs1# configure
...
--
====
. [[step14]] Confirmez la configuration de réseau de cluster suivante : `network port show`
+
[listing]
----
cluster1::*> network port show -ipspace Cluster
