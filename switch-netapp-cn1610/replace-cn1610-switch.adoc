...
----
====
. Vérifiez que les versions du commutateur et d'ONTAP correspondent dans la matrice de compatibilité. Consultez link:https://mysupport.netapp.com/site/info/netapp-cluster-switch["Commutateurs NetApp CN1601 et CN1610"^] pour plus de détails.
. À partir du link:https://mysupport.netapp.com/site/products/all/details/netapp-cluster-switches/downloads-tab["page de téléchargement de logiciels"^] sur le site de support NetApp, sélectionnez NetApp Cluster Switches pour télécharger les versions RCF et FASTPATH appropriées.
