...
NOTE: Pour plus d'informations sur l'installation de Cumulus Linux, consultezlink:configure-software-sn2100-storage.html["Processus d'installation logicielle pour les commutateurs NVIDIA SN2100"] .
...
Après avoir réinitialisé vos interrupteurs, vous pouvezlink:configure-overview-sn2100-storage.html["reconfigurer"] eux selon les besoins.
