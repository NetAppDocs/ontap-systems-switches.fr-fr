...
Après avoir remplacé le commutateur CN1610 CL2, vous pouvezlink:cn1610-replace-CL1.html["remplacer le commutateur CN1610 CL1 par le commutateur 3232C C1"] .
