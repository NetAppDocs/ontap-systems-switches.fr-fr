...
* link:required-documentation-9364d-cluster.html["Documentation relative aux commutateurs et à ONTAP requise"] .
...
.Et la suite ?
Après avoir configuré vos commutateurs, vouslink:install-nxos-overview-9364d-cluster.html["préparer l'installation de NX-OS et RCF"] .
