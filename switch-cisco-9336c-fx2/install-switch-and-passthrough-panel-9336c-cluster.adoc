...
* Pour connaître les exigences de préparation initiale, le contenu du kit et les précautions de sécurité, reportez-vous au link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/aci_9336cfx2_hig/guide/b_n9336cFX2_aci_hardware_installation_guide.html["Guide d'installation matérielle de la gamme Cisco Nexus 9000"^].
...
+
Dans cette procédure, le panneau d'obturation est installé dans U40.
...
Une fois les commutateurs installés dans l'armoire NetApp , vous pouvezlink:setup-switch-9336c-cluster.html["configurer les commutateurs Cisco Nexus 9336C-FX2 et 9336C-FX2-T"] .
