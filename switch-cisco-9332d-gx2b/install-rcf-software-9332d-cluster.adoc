...
[role="lead"]
Vous installez le RCF après avoir configuré le commutateur Nexus 9332D-GX2B pour la première fois.
...
+
Pour plus d'informations sur les commandes Cisco, reportez-vous au guide approprié dans les  https://www.cisco.com/c/en/us/support/switches/nexus-9336c-fx2-switch/model.html#CommandReferences["Guide de référence des commandes NX-OS Cisco Nexus série 9000"^] guides.
