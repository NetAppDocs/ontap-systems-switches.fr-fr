...
summary: 'Le logiciel Cisco NX-OS et les fichiers de configuration de référence (RCF) doivent être installés sur les commutateurs de cluster Cisco Nexus 9332D-GX2B.' 
---
...
* Les noms du cluster LIF sont :
+
** node1-01_clus1 et node1-01_clus2 pour node1-01
** node1-02_clus1 et node1-02_clus2 pour node1-02
** node1-03_clus1 et node1-03_clus2 pour node1-03
** node1-04_clus1 et node1-04_clus2 pour node1-04
...
.. *Ports de cluster*
+
... Affichez le nombre d'interfaces d'interconnexion de cluster configurées dans chaque nœud pour chaque commutateur :
+
[source, cli]
----
...
----
====
... Afficher les informations sur les LIF du cluster :
+
[source, cli]
----
...
.. *Ports HA*
+
... Afficher les informations sur les ports HA :
+
...
.. *Ports de stockage*
+
... Afficher les informations sur les ports de stockage :
+
[source, cli]
----
...
. Vérifiez que la commande de réinitialisation automatique est activée sur tous les LIF du cluster :
+
[source, cli]
----
...
Une fois que vous avez préparé l'installation du logiciel NX-OS et de RCF, vous link:install-nxos-software-9332d-cluster.html["installer ou mettre à niveau le logiciel NX-OS"].
