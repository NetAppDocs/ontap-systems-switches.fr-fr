...
.Et la suite ?
En option, vous pouvezlink:install-switch-and-passthrough-panel-9336c-storage.html["Installez un commutateur Cisco Nexus 9336C-FX2 dans une armoire NetApp"] . Sinon, allez àlink:setup-switch-9336c-storage.html["configurer le commutateur"] .
