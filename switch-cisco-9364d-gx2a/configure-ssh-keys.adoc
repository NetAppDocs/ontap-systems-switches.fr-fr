...
summary: 'L"utilisation du protocole SSH est requise pour le moniteur d"intégrité des commutateurs de cluster (CSHM) et la collecte des journaux. Pour activer SSH sur les commutateurs de cluster Cisco 9364d-gx2a, vous générez d"abord les clés SSH, puis vous activez SSH.' 
---
