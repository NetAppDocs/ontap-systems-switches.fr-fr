...
summary: 'SSH est requis lors de l"utilisation des fonctionnalités de contrôle de l"état des commutateurs de cluster et de collecte des journaux. Pour activer SSH sur les commutateurs de cluster Cisco 9364d-gx2a, vous devez d"abord générer les clés SSH, puis activer SSH.' 
---
