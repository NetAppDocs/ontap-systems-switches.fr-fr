...
Une fois que vous avez préparé l'installation du logiciel NX-OS et de RCF, vous pouvez link:install-nxos-software-9336c-cluster.html["installer ou mettre à niveau le logiciel NX-OS"].
