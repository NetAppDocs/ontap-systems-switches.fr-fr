...
.Et la suite ?
Une fois votre commutateur configuré, vous link:install-cumulus-mode-sn2100-cluster.html["installer Cumulus Linux en mode Cumulus"] ou link:install-onie-mode-sn2100-cluster.html["installer Cumulus Linux en mode ONIE"].
