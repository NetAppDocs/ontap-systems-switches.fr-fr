...
. Sur le commutateur de cluster cs2, arrêter les ports connectés aux ports de cluster des nœuds afin de basculer les LIFs du cluster :
+
[listing, subs="+quotes"]
----
...
----
. Sur le commutateur de cluster cs1, arrêter les ports connectés aux ports de cluster des nœuds afin de basculer les LIFs du cluster. L'exemple suivant utilise la sortie d'exemple d'interface de STEP 7.
+
[listing, subs="+quotes"]
----
...
--
====
. [[step5]]activez la fonction de collecte des journaux du moniteur d'intégrité du commutateur Ethernet pour collecter les fichiers journaux liés au commutateur.
