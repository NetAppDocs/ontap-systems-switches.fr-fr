...
summary: Réinitialisez le commutateur 9364D-GX2A à ses paramètres d’usine. 
---
= Réinitialiser le commutateur 9364D-GX2A aux paramètres d'usine
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Pour réinitialiser le commutateur 9364D-GX2A aux paramètres d'usine, vous devez effacer les paramètres du commutateur 9364D-GX2A.
