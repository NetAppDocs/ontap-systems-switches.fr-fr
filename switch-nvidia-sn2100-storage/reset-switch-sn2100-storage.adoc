...
NOTE: Pour plus d'informations sur l'installation de Cumulus Linux, consultezlink:configure-software-sn2100-storage.html["Workflow d'installation logicielle pour les switchs NVIDIA SN2100"] .
