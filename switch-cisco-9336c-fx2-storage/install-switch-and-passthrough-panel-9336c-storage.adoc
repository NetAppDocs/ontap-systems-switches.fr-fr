...
Après avoir installé les commutateurs dans l'armoire NetApp , vouslink:setup-switch-9336c-storage.html["configurer les commutateurs Cisco Nexus 9336C-FX2 et 9336C-FX2-T"] .
