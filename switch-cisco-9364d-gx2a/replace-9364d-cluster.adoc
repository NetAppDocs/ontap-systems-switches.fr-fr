...
summary: 'Le remplacement d"un commutateur Nexus 9364d-gx2a défectueux dans un réseau en cluster est une procédure non perturbatrice.' 
---
...
----
====
. Activez tous les ports sur le commutateur newcs2.
+
.Afficher un exemple
[%collapsible]
====
