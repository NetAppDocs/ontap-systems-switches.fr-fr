...
---
= Réinitialiser les commutateurs de cluster 9336C-FX2 et 9336C-FX2-T aux paramètres d'usine par défaut
:allow-uri-read: 


[role="lead"]
Pour réinitialiser les commutateurs de cluster 9336C-FX2 et 9336C-FX2-T aux paramètres d'usine par défaut, vous devez effacer les paramètres des commutateurs 9336C-FX2 et 9336C-FX2-T.
...
Après avoir réinitialisé vos interrupteurs, vous pouvezlink:configure-switch-overview-9336c-cluster.html["reconfigurer"] eux selon les besoins.
