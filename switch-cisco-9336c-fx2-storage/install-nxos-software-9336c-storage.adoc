...
* Les logiciels et guides de mise à niveau appropriés disponibles sur le site Web de Cisco pour les procédures de mise à niveau et de mise à niveau vers une version antérieure du commutateur Cisco. Voir https://["Commutateurs Cisco Nexus 9000 Series"^].
