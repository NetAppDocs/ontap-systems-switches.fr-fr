...
Les exemples de cette procédure utilisent deux nœuds, chacun utilisant deux ports d'interconnexion de cluster 40 GbE, e4a et e4e. Le link:https://hwu.netapp.com/["Hardware Universe"^] contient des détails sur les ports de cluster de vos plateformes.
