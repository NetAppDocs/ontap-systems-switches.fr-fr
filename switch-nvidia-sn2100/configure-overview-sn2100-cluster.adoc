...
summary: Le commutateur NVIDIA SN2100 est un commutateur Ethernet 10/25/40/100 GbE fonctionnant sous Cumulus Linux.  Le commutateur SN2100 prend en charge les applications de cluster et de stockage dans ONTAP 9.10.1 sur différentes paires de commutateurs. 
---
...
[role="lead"]
Le NVIDIA SN2100 est un commutateur de cluster qui vous permet de créer des clusters ONTAP avec plus de deux nœuds.

Suivez ces étapes de flux de travail pour installer et configurer vos commutateurs NVIDIA SN2100.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["Un"]link:configure-reqs-sn2100-cluster.html["Examiner les exigences de configuration"]
