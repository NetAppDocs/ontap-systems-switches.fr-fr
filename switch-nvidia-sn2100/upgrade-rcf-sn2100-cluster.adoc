...
---
= Mettez à niveau le script RCF (Reference Configuration File)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Suivez cette procédure pour mettre à niveau le script RCF.

.Avant de commencer
Avant de mettre à niveau le script RCF, assurez-vous que les éléments suivants sont disponibles sur le commutateur :
