...
[role="lead"]
Suivez cette procédure pour configurer le protocole SNMPv3 qui prend en charge la collecte du journal de commutation et la surveillance de l'état du commutateur (SHM).
