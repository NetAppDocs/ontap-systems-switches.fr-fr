...
+
Consultez l'article de la base de connaissances link:https://kb.netapp.com/on-prem/Switches/Cisco-KBs/How_to_clear_configuration_on_a_Cisco_interconnect_switch_while_retaining_remote_connectivity["Comment effacer la configuration d'un commutateur d'interconnexion Cisco tout en conservant la connectivité à distance"^] pour plus de détails.
...
. Copiez le RCF dans la mémoire flash de démarrage du commutateur cs1 en utilisant l'un des protocoles de transfert suivants : FTP, SFTP ou SCP.
+
Pour plus d'informations sur les commandes Cisco, reportez-vous au guide approprié dans le link:https://www.cisco.com/c/en/us/support/switches/nexus-9336c-fx2-switch/model.html#CommandReferences["Guide de référence des commandes NX-OS Cisco Nexus série 9000"^].

+
Cet exemple montre SFTP utilisé pour copier un RCF dans la bootflash sur le commutateur cs1 :
...
CAUTION: Si votre commutateur 9336C-FX2 ne démarre pas après la mise à niveau de votre RCF, consultez l’article de la base de connaissances NetApp link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Cisco_9336C-FX2_Switch_Fails_to_Boot_After_RCF_Install_%E2%80%93_Boot_Variable_Cleared["Cisco 9336C-FX2 Switch ne démarre pas après l'installation de RCF – variable de démarrage effacée"^] pour connaître les prochaines étapes.
