...
Deux scripts RCF sont disponibles pour les applications de cluster et de stockage. Téléchargez les fichiers RCF depuis https://mysupport.netapp.com/site/info/nvidia-cluster-switch["ici"^]. La procédure pour chaque est la même.
