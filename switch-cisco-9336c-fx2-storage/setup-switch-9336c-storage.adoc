...
.Et la suite ?
Si vous le souhaitez, vous pouvez link:install-switch-and-passthrough-panel-9336c-storage.html["Installez le commutateur dans l'armoire NetApp"]. Sinon, passez à link:install-nxos-overview-9336c-storage.html["Préparez-vous à installer NX-OS et RCF"].
